...
import { View, Text, StyleSheet, ScrollView, FlatList, TouchableHighlight, TouchableOpacity, StatusBar } from 'react-native';
                ...
                <View style={styles.container}>
                    <ScrollView>
                        ...
                        </View>
                        {
                            ...
                            <Text style={{ color: Color.Danger }}> Invalid order. Try again!</Text>
                        }
                        <View style={styles.form}>
                            <FlatList
